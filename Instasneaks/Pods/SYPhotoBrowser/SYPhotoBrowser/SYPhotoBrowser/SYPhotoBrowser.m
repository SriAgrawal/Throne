...
- (void)addCrossButton {
    ...
    self.crossButton.frame = CGRectMake(0, 0, 60, 60);
    [self.crossButton setTitle:@"" forState:UIControlStateNormal];
    [self.crossButton setImage:[UIImage imageNamed:@"ico_cross_white"] forState:UIControlStateNormal];
    [self.crossButton addTarget:self action:@selector(handleDissmissNotification:) forControlEvents:UIControlEventTouchUpInside];
