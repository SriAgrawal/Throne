...
@interface ISBrandDetailHeaderView : UIView

@property (weak, nonatomic) IBOutlet UIButton   * burtton_back;
@property (weak, nonatomic) IBOutlet UIButton   * burtton_search;
@property (weak, nonatomic) IBOutlet UILabel    * label_header;
...
@property (strong, nonatomic) IBOutlet UIButton *button_gender;
