...
- (UIEdgeInsets)contentInsetForScrollView:(CGFloat)targetZoomScale {
    ...
    if(minContentHeight > WIN_HEIGHT - 100){
        minContentHeight = minContentHeight - (float)(minContentHeight*20)/100;
        minContentWidth = minContentWidth - (float)(minContentWidth *20)/100;
    }
...
- (CGRect)resizedFrameForAutorotatingImageView:(CGSize)imageSize {
    ...
    if(targetHeight > WIN_HEIGHT - 100){
        targetHeight = targetHeight - (float)(targetHeight*20)/100;
        targetWidth = targetWidth - (float)(targetWidth *20)/100;
    }
